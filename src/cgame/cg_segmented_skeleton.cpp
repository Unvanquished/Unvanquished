...
void HumanSkeletonRotations::Apply( const SkeletonModifierContext& ctx, refEntity_t* ent, refEntity_t* unused )
{
	BoneMod mod;
...
void BsuitSkeletonRotations::Apply( const SkeletonModifierContext& ctx, refEntity_t* ent, refEntity_t* unused )
{
	BoneMod mod;
	VectorCopy( vec3_origin, mod.translation );
...
void SegmentedSkeletonCombiner::Apply( const SkeletonModifierContext& ctx, refEntity_t* ent, refEntity_t* unused )
{
	BoneMod boneMod;
	boneMod.type            = 1;
