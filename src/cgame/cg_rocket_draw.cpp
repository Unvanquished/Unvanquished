...
static void CG_Rocket_DrawDisconnect()
{
	...
	CG_DrawPic( x, y, 48, 48, trap_R_RegisterShader( "gfx/feedback/net", (RegisterShaderFlags_t) ( RSF_2D | RSF_FITSCREEN ) ) );
}
...
public:
	...
	void DoOnUpdate() override
	{
		...
		if ( mapIndex_ != rocketInfo.data.mapIndex )
		{
			...
			FS::PakPath::LoadPakPrefix( pak, Str::Format( "levelshots/%s", mapName ), ignored );
