...
void Rocket_Init()
{
	...
	Unv::CGame::Lua::RegisterCDataSource(Rml::Lua::Interpreter::GetLuaState());
	Unv::CGame::Lua::RegisterEvents(Rml::Lua::Interpreter::GetLuaState());
...
void Rocket_Update()
{
	...
	Unv::Shared::Lua::UpdateTimers(rocketInfo.realtime);
}
