...
typedef struct wrapType_s {
    ...
    inline struct wrapType_s &operator = ( wrapTypeEnum_t w ) {
        this->s = this->t = w;
        return *this;
    }
...
static inline bool operator == ( const wrapType_t &a, const wrapType_t &b )
{
...
inline bool IsImageCompressed ( int bits )
{
    return bits & ( IF_BC1 | IF_BC3 | IF_BC4 | IF_BC5 );
}
