...
void QDECL Com_Error( int level, const char *error, ... ) _attribute( ( format( printf,2,3 ), noreturn ) );
...
#define BUTTON_ATTACK2		256
#define BUTTON_DODGE        512         // start a dodge or sprint motion
#define BUTTON_USE_EVOLVE   1024        // use target or open evolve menu
#define BUTTON_GETFLAG		2048
