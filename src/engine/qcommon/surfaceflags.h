...
#define CONTENTS_LIGHTGRID          0x00000002
#define CONTENTS_LAVA               0x00000004
#define CONTENTS_SLIME              0x00000008
#define CONTENTS_WATER              0x00000010
#define CONTENTS_FOG                0x00000020
#define CONTENTS_MISSILECLIP        0x00000040
#define CONTENTS_ITEM               0x00000080
#define CONTENTS_AI_NOSIGHT         0x00000100 // wolf ai sight blocking
#define CONTENTS_MOVER              0x00000200
#define CONTENTS_AREAPORTAL         0x00000400
#define CONTENTS_PLAYERCLIP         0x00000800
#define CONTENTS_MONSTERCLIP        0x00001000
#define CONTENTS_TELEPORTER         0x00002000
#define CONTENTS_JUMPPAD            0x00004000
#define CONTENTS_CLUSTERPORTAL      0x00008000
#define CONTENTS_DONOTENTER         0x00010000
#define CONTENTS_DONOTENTER_LARGE   0x00020000
#define CONTENTS_ORIGIN             0x00040000 // removed before bsping an entity
#define CONTENTS_BODY               0x00080000 // should never be on a brush, only in game
#define CONTENTS_CORPSE             0x00100000
#define CONTENTS_DETAIL             0x00200000 // brushes not used for the bsp
#define CONTENTS_STRUCTURAL         0x00400000 // brushes used for the bsp
#define CONTENTS_TRANSLUCENT        0x00800000 // don't consume surface fragments inside
#define CONTENTS_TRIGGER            0x01000000
#define CONTENTS_NODROP             0x02000000 // don't leave bodies or items (death fog, lava)
// Dushan - Tremulous - custominfoparms below
#define CONTENTS_TREM_NOALIENBUILD  0x00000001 //disallow alien building
#define CONTENTS_TREM_NOHUMANBUILD  0x00000002 //disallow human building
#define CONTENTS_TREM_NOBUILD       0x00000004 //disallow building
...
#define SURF_TREM_NOHUMANBUILD      0x00000002 //disallow human building
#define SURF_TREM_NOBUILD           0x00000004 //disallow building
