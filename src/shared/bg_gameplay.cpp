...
const int   ALIEN_SPAWN_REPEAT_TIME = 2000;
...
const int   ALIEN_TK_SUICIDE_PENALTY = 2000;
...
const int   HUMAN_SPAWN_REPEAT_TIME = 2000;

const int   HUMAN_BUILDABLE_REGEN_WAIT = 5000;

const int   HUMAN_MAX_CREDITS = 250;
const int   HUMAN_TK_SUICIDE_PENALTY = 250;
