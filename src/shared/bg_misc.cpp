...
===============
*/
trace_t BG_PositionBuildableRelativeToPlayer( playerState_t *ps,
    buildable_t buildable,
    trace_t ( *trace )( buildable_t, const vec3_t, const vec3_t, int, int, int ),
    vec3_t outOrigin, vec3_t outAngles )
{
	...
	trace_t tr = ( *trace )( buildable, entityOrigin, targetOrigin, ps->clientNum, MASK_DEADSOLID, 0 );
