...
GET_FUNC2( bp, proxy->attributes->buildPoints, integer )
GET_FUNC2( power_consumption, proxy->attributes->powerConsumption, integer )
...
int Buildables::index( lua_State* L )
{
	...
	if ( buildable && buildable - 1 < buildables.size() )
	{
