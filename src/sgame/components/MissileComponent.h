...
===========================================================================
*/
#ifndef MISSILE_COMPONENT_H_
#define MISSILE_COMPONENT_H_

#include "../backend/CBSEBackend.h"
#include "../backend/CBSEComponents.h"

class MissileComponent: public MissileComponentBase {
	public:
		// ///////////////////// //
		...
		/**
		 * @brief Default constructor of the MissileComponent.
		 * @param entity The entity that owns the component instance.
		 * @param attributes An initialization parameter.
		 ...
		 */
		MissileComponent(Entity& entity, const missileAttributes_t* attributes, ThinkingComponent& r_ThinkingComponent);
