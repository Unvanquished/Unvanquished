...
class AlienBuildableComponent: public AlienBuildableComponentBase {
	public:
		 ...
		 */
		AlienBuildableComponent(Entity& entity, BuildableComponent& r_BuildableComponent, TeamComponent& r_TeamComponent, IgnitableComponent& r_IgnitableComponent);
		 ...
		 * @note This method is an interface for autogenerated code, do not modify its signature.
		 */
		void HandleDamage(float amount, gentity_t* source, vec3_t location, vec3_t direction, int flags, meansOfDeath_t meansOfDeath);
