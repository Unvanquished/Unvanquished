...
Cvar::Cvar<int> g_teamStatus("g_teamStatus", "allow /teamstatus command. 0 = disabled, otherwise you can only /teamstatus every <g_teamStatus> seconds.", Cvar::NONE, 0);
...
Cvar::Cvar<int>   g_maxMiners("g_maxMiners", "set maximum number of miners per team. -1 = disabled.", Cvar::NONE, 4);
Cvar::Cvar<float> g_minMinerEfficiency("g_minMinerEfficiency", "minimum miner efficiency required to build. From 0 to 1.", Cvar::NONE, 0.98f);
