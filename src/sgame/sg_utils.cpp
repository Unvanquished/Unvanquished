...
/*
================
Get the forward, right, up, and muzzle vectors for a given entity.
Currently supports players and buildables.
================
*/
void G_GetFRUMVectors( gentity_t* ent, vec3_t forward, vec3_t right, vec3_t up, vec3_t muzzle )
{
	if ( ent->client )
	{
