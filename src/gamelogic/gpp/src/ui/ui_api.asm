...
equ trap_Parse_FreeSource                 -343
equ trap_Parse_ReadToken                  -344
equ trap_Parse_SourceFileAndLine          -345
equ trap_PC_AddGlobalDefine               -346
equ trap_PC_RemoveAllGlobalDefines        -347
equ trap_PC_LoadSource                    -348
equ trap_PC_FreeSource                    -349
equ trap_PC_ReadToken                     -350
equ trap_PC_SourceFileAndLine             -351
equ trap_PC_UnReadToken                   -352
equ trap_S_StopBackgroundTrack            -353
equ trap_S_StartBackgroundTrack           -354
equ trap_RealTime                         -355
equ trap_CIN_PlayCinematic                -356
equ trap_CIN_StopCinematic                -357
equ trap_CIN_RunCinematic                 -358
equ trap_CIN_DrawCinematic                -359
...
equ trap_R_RegisterAnimation              -368
equ trap_R_BuildSkeleton                  -369
equ trap_R_BlendSkeleton                  -370
equ trap_R_BoneIndex                      -371
equ trap_R_AnimNumFrames                  -372
equ trap_R_AnimFrameRate                  -373
equ trap_R_Glyph                          -375
equ trap_R_GlyphChar                      -376
equ trap_R_UnregisterFont                 -377
