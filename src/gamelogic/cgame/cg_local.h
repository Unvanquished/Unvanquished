...
void Rocket_SetInnerRMLById( const char *name, const char *id, const char *RML, qboolean parseQuake );
void Rocket_SetInnerRML( const char *RML, qboolean parseQuake );
