...
equ trap_Rocket_Init                      -444
equ trap_Rocket_Shutdown                  -445
equ trap_Rocket_LoadDocument              -446
equ trap_Rocket_LoadCursor                -447
equ trap_Rocket_DocumentAction            -448
equ trap_Rocket_GetEvent                  -449
equ trap_Rocket_DeleteEvent               -450
equ trap_Rocket_RegisterDataSource        -451
equ trap_Rocket_DSAddRow                  -452
equ trap_Rocket_DSChangeRow               -453
equ trap_Rocket_DSRemoveRow               -454
