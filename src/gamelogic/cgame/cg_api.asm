...
equ trap_Cmd_ExecuteText                  -447
equ trap_Rocket_Init                      -448
equ trap_Rocket_Shutdown                  -449
equ trap_Rocket_LoadDocument              -450
equ trap_Rocket_LoadCursor                -451
equ trap_Rocket_DocumentAction            -452
equ trap_Rocket_GetEvent                  -453
equ trap_Rocket_DeleteEvent               -454
equ trap_Rocket_RegisterDataSource        -455
equ trap_Rocket_DSAddRow                  -456
equ trap_Rocket_DSChangeRow               -457
equ trap_Rocket_DSRemoveRow               -458
equ trap_Rocket_DSClearTable              -459
equ trap_Rocket_SetInnerRML               -460
equ trap_Rocket_GetAttribute              -461
equ trap_Rocket_SetAttribute              -462
equ trap_Rocket_GetEventParameters        -463
equ trap_Rocket_RegisterDataFormatter     -464
equ trap_Rocket_DataFormatterRawData      -465
equ trap_Rocket_DataFormatterFormattedData -466
equ trap_Rocket_RegisterElement           -467
equ trap_Rocket_SetElementDimensions      -468
equ trap_Rocket_GetElementTag             -469
equ trap_Rocket_KeyToQuake                -470
equ trap_Rocket_GetElementAbsoluteOffset  -471
equ trap_Rocket_DrawElementPic            -472
equ trap_Rocket_ClearElementGeometry      -473
