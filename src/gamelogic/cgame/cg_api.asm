...
equ trap_Cmd_ExecuteText                  -449
equ trap_R_GetShaderNameFromHandle        -450
equ trap_Rocket_Init                      -451
equ trap_Rocket_Shutdown                  -452
equ trap_Rocket_LoadDocument              -453
equ trap_Rocket_LoadCursor                -454
equ trap_Rocket_DocumentAction            -455
equ trap_Rocket_GetEvent                  -456
equ trap_Rocket_DeleteEvent               -457
equ trap_Rocket_RegisterDataSource        -458
equ trap_Rocket_DSAddRow                  -459
equ trap_Rocket_DSChangeRow               -460
equ trap_Rocket_DSRemoveRow               -461
equ trap_Rocket_DSClearTable              -462
equ trap_Rocket_SetInnerRML               -463
equ trap_Rocket_GetAttribute              -464
equ trap_Rocket_SetAttribute              -465
equ trap_Rocket_GetProperty               -466
equ trap_Rocket_SetPropertyById           -467
equ trap_Rocket_GetEventParameters        -468
equ trap_Rocket_RegisterDataFormatter     -469
equ trap_Rocket_DataFormatterRawData      -470
equ trap_Rocket_DataFormatterFormattedData -471
equ trap_Rocket_RegisterElement           -472
equ trap_Rocket_SetElementDimensions      -473
equ trap_Rocket_GetElementTag             -474
equ trap_Rocket_KeyToQuake                -475
