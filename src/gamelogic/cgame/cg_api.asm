...
equ trap_Cmd_ExecuteText                  -444
equ trap_Rocket_Init                      -445
equ trap_Rocket_Shutdown                  -446
equ trap_Rocket_LoadDocument              -447
equ trap_Rocket_LoadCursor                -448
equ trap_Rocket_DocumentAction            -449
equ trap_Rocket_GetEvent                  -450
equ trap_Rocket_DeleteEvent               -451
equ trap_Rocket_RegisterDataSource        -452
equ trap_Rocket_DSAddRow                  -453
