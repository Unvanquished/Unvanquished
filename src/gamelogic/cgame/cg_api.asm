...
equ trap_Rocket_GetEventParameters        -465
equ trap_Rocket_RegisterDataFormatter     -466
equ trap_Rocket_DataFormatterRawData      -467
equ trap_Rocket_DataFormatterFormattedData -468
equ trap_Rocket_RegisterElement           -469
equ trap_Rocket_SetElementDimensions      -470
equ trap_Rocket_GetElementTag             -471
equ trap_Rocket_KeyToQuake                -472
equ trap_Rocket_GetElementAbsoluteOffset  -473
equ trap_Rocket_DrawElementPic            -474
equ trap_Rocket_ClearElementGeometry      -475
