...
equ trap_Rocket_Init                      -450
equ trap_Rocket_Shutdown                  -451
equ trap_Rocket_LoadDocument              -452
equ trap_Rocket_LoadCursor                -453
equ trap_Rocket_DocumentAction            -454
equ trap_Rocket_GetEvent                  -455
equ trap_Rocket_DeleteEvent               -456
equ trap_Rocket_RegisterDataSource        -457
equ trap_Rocket_DSAddRow                  -458
equ trap_Rocket_DSChangeRow               -459
equ trap_Rocket_DSRemoveRow               -460
equ trap_Rocket_DSClearTable              -461
equ trap_Rocket_SetInnerRML               -462
equ trap_Rocket_GetAttribute              -463
equ trap_Rocket_SetAttribute              -464
equ trap_Rocket_GetProperty               -465
equ trap_Rocket_SetPropertyById           -466
equ trap_Rocket_GetEventParameters        -467
equ trap_Rocket_RegisterDataFormatter     -468
equ trap_Rocket_DataFormatterRawData      -469
equ trap_Rocket_DataFormatterFormattedData -470
equ trap_Rocket_RegisterElement           -471
equ trap_Rocket_SetElementDimensions      -472
equ trap_Rocket_GetElementTag             -473
equ trap_Rocket_KeyToQuake                -474
equ trap_Rocket_GetElementAbsoluteOffset  -475
equ trap_Rocket_QuakeToRML                -476
equ trap_Rocket_SetClass                  -477
equ trap_Rocket_InitializeHuds            -478
equ trap_Rocket_LoadUnit                  -479
equ trap_Rocket_AddUnitToHud              -480
equ trap_Rocket_ShowHud                   -481
equ trap_Rocket_ClearHud                  -482
