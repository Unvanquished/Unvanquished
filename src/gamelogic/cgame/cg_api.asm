...
equ trap_CIN_PlayCinematic                -370
equ trap_CIN_StopCinematic                -371
equ trap_CIN_RunCinematic                 -372
equ trap_CIN_DrawCinematic                -373
equ trap_CIN_SetExtents                   -374
equ trap_R_RemapShader                    -375
equ trap_GetEntityToken                   -376
equ trap_UI_Popup                         -377
equ trap_UI_ClosePopup                    -378
equ trap_Key_GetBindingBuf                -379
equ trap_Key_SetBinding                   -380
equ trap_Parse_AddGlobalDefine            -381
equ trap_Parse_LoadSource                 -382
equ trap_Parse_FreeSource                 -383
equ trap_Parse_ReadToken                  -384
equ trap_Parse_SourceFileAndLine          -385
equ trap_Key_KeynumToStringBuf            -386
equ trap_S_FadeAllSound                   -387
equ trap_R_inPVS                          -388
equ trap_GetHunkData                      -389
equ trap_R_LoadDynamicShader              -390
equ trap_R_RenderToTexture                -391
equ trap_R_GetTextureId                   -392
equ trap_R_Finish                         -393
equ trap_GetDemoName                      -394
equ trap_R_LightForPoint                  -395
equ trap_R_RegisterAnimation              -396
equ trap_R_CheckSkeleton                  -397
equ trap_R_BuildSkeleton                  -398
equ trap_R_BlendSkeleton                  -399
equ trap_R_BoneIndex                      -400
equ trap_R_AnimNumFrames                  -401
equ trap_R_AnimFrameRate                  -402
equ trap_CompleteCallback                 -403
equ trap_RegisterButtonCommands           -404
equ trap_GetClipboardData                 -405
equ trap_QuoteString                      -406
equ trap_Gettext                          -407
equ trap_R_Glyph                          -408
equ trap_R_GlyphChar                      -409
equ trap_R_UnregisterFont                 -410
equ trap_Pgettext                         -411
equ trap_R_inPVVS                         -412
equ trap_notify_onTeamChange              -413
equ trap_GettextPlural                    -414
equ trap_RegisterVisTest                  -415
equ trap_AddVisTestToScene                -416
equ trap_CheckVisibility                  -417
equ trap_UnregisterVisTest                -418
equ trap_SetColorGrading                  -419
equ trap_CM_DistanceToModel               -420
equ trap_R_ScissorEnable                  -421
equ trap_R_ScissorSet                     -422
equ trap_PrepareKeyUp                     -423
equ trap_R_SetAltShaderTokens             -424
equ trap_S_UpdateEntityVelocity           -425
equ trap_S_SetReverb                      -426
equ trap_S_BeginRegistration              -427
equ trap_S_EndRegistration                -428
