...
equ trap_R_GetTextureId                   -398
equ trap_R_Finish                         -399
equ trap_GetDemoName                      -400
equ trap_R_LightForPoint                  -401
equ trap_S_SoundDuration                  -402
equ trap_R_RegisterAnimation              -403
equ trap_R_CheckSkeleton                  -404
equ trap_R_BuildSkeleton                  -405
equ trap_R_BlendSkeleton                  -406
equ trap_R_BoneIndex                      -407
equ trap_R_AnimNumFrames                  -408
equ trap_R_AnimFrameRate                  -409
equ trap_CompleteCallback                 -410
equ trap_RegisterButtonCommands           -411
equ trap_GetClipboardData                 -412
equ trap_QuoteString                      -413
equ trap_Gettext                          -414
equ trap_R_Glyph                          -415
