...
equ trap_Rocket_GetEventParameters        -462
equ trap_Rocket_RegisterDataFormatter     -463
equ trap_Rocket_DataFormatterRawData      -464
equ trap_Rocket_DataFormatterFormattedData -465
equ trap_Rocket_RegisterElement           -466
equ trap_Rocket_SetElementDimensions      -467
equ trap_Rocket_GetElementTag             -468
equ trap_Rocket_KeyToQuake                -469
equ trap_Rocket_GetElementAbsoluteOffset  -470
equ trap_Rocket_DrawElementPic            -471
equ trap_Rocket_ClearElementGeometry      -472
