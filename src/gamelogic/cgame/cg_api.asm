...
equ trap_loadCamera                       -380
equ trap_startCamera                      -381
equ trap_stopCamera                       -382
equ trap_getCameraInfo                    -383
equ trap_GetEntityToken                   -384
equ trap_UI_Popup                         -385
equ trap_UI_ClosePopup                    -386
equ trap_Key_GetBindingBuf                -387
equ trap_Key_SetBinding                   -388
equ trap_Parse_AddGlobalDefine            -389
equ trap_Parse_LoadSource                 -390
equ trap_Parse_FreeSource                 -391
equ trap_Parse_ReadToken                  -392
equ trap_Parse_SourceFileAndLine          -393
equ trap_Key_KeynumToStringBuf            -394
equ trap_Key_KeysForBinding               -395
equ trap_S_FadeAllSound                   -397
equ trap_R_inPVS                          -398
equ trap_GetHunkData                      -399
equ trap_R_LoadDynamicShader              -400
equ trap_R_RenderToTexture                -401
equ trap_R_GetTextureId                   -402
equ trap_R_Finish                         -403
equ trap_GetDemoName                      -404
equ trap_R_LightForPoint                  -405
equ trap_S_SoundDuration                  -406
equ trap_R_RegisterAnimation              -407
equ trap_R_CheckSkeleton                  -408
equ trap_R_BuildSkeleton                  -409
equ trap_R_BlendSkeleton                  -410
equ trap_R_BoneIndex                      -411
equ trap_R_AnimNumFrames                  -412
equ trap_R_AnimFrameRate                  -413
equ trap_CompleteCallback                 -414
equ trap_RegisterButtonCommands           -415
equ trap_GetClipboardData                 -416
equ trap_QuoteString                      -417
equ trap_Gettext                          -418
equ trap_R_Glyph                          -419
equ trap_R_GlyphChar                      -420
equ trap_R_UnregisterFont                 -421
equ trap_Pgettext                         -422
