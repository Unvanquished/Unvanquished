...
{
	return 0;//syscall( G_DEBUG_POLYGON_CREATE, color, numPoints, points );
}
...
{
	return 0;//syscall( BOTLIB_SHUTDOWN );
}
...
{
	return 0;//syscall( BOTLIB_LIBVAR_SET, var_name, value );
}
...
{
	return 0;//syscall( BOTLIB_LIBVAR_GET, var_name, value, size );
}
...
{
	return 0;//syscall( BOTLIB_PC_ADD_GLOBAL_DEFINE, string );
}
...
{
	return 0;//syscall( BOTLIB_PC_LOAD_SOURCE, filename );
}
...
{
	return 0;//syscall( BOTLIB_PC_FREE_SOURCE, handle );
}
...
{
	return 0;//syscall( BOTLIB_PC_READ_TOKEN, handle, pc_token );
}
...
{
	return 0;//syscall( BOTLIB_PC_SOURCE_FILE_AND_LINE, handle, filename, line );
}
...
{
	return 0;//syscall( BOTLIB_PC_UNREAD_TOKEN, handle );
}
...
{
	return 0;//syscall( BOTLIB_START_FRAME, PASSFLOAT( time ) );
}
...
{
	return 0;//syscall( BOTLIB_LOAD_MAP, mapname );
}
...
{
	return 0;//syscall( BOTLIB_UPDATENTITY, ent, bue );
}
...
{
	return 0;//syscall( BOTLIB_TEST, parm0, parm1, parm2, parm3 );
}
...
{
	return 0;//syscall( BOTLIB_GET_SNAPSHOT_ENTITY, clientNum, sequence );
}
...
{
	return 0;//syscall( BOTLIB_GET_CONSOLE_MESSAGE, clientNum, message, size );
}
...
{
	return 0;//syscall( BOTLIB_AAS_INITIALIZED );
}
...
{
	return 0;//syscall( BOTLIB_AAS_POINT_AREA_NUM, point );
}
...
{
	return 0;//syscall( BOTLIB_AAS_TRACE_AREAS, start, end, areas, points, maxareas );
}
...
{
	return 0;//syscall( BOTLIB_AAS_BBOX_AREAS, absmins, absmaxs, areas, maxareas );
}
...
{
	return 0;//syscall( BOTLIB_AAS_AREA_WAYPOINT, areanum, center );
}
...
{
	return 0;//syscall( BOTLIB_AAS_POINT_CONTENTS, point );
}
...
{
	return 0;//syscall( BOTLIB_AAS_NEXT_BSP_ENTITY, ent );
}
...
{
	return 0;//syscall( BOTLIB_AAS_VALUE_FOR_BSP_EPAIR_KEY, ent, key, value, size );
}
...
{
	return 0;//syscall( BOTLIB_AAS_VECTOR_FOR_BSP_EPAIR_KEY, ent, key, v );
}
...
{
	return 0;//syscall( BOTLIB_AAS_FLOAT_FOR_BSP_EPAIR_KEY, ent, key, value );
}
...
{
	return 0;//syscall( BOTLIB_AAS_INT_FOR_BSP_EPAIR_KEY, ent, key, value );
}
...
{
	return 0;//syscall( BOTLIB_AAS_AREA_REACHABILITY, areanum );
}
...
{
	return 0;//syscall( BOTLIB_AAS_AREA_LADDER, areanum );
}
...
{
	return 0;//syscall( BOTLIB_AAS_AREA_TRAVEL_TIME_TO_GOAL_AREA, areanum, origin, goalareanum, travelflags );
}
...
{
	return 0;//syscall( BOTLIB_AAS_SWIMMING, origin );
}
...
{
	return 0;//syscall( BOTLIB_AAS_PREDICT_CLIENT_MOVEMENT, move, entnum, origin, presencetype, onground, velocity, cmdmove, cmdframes, maxframes, PASSFLOAT( frametime ), stopevent, stopareanum, visualize );
}
...
{
	return 0;//syscall( BOTLIB_AAS_NEARESTHIDEAREA, srcnum, origin, areanum, enemynum, enemyorigin, enemyareanum, travelflags, PASSFLOAT( maxdist ), distpos );
}
...
{
	return 0;//syscall( BOTLIB_AAS_LISTAREASINRANGE, srcpos, srcarea, PASSFLOAT( range ), travelflags, outareas, maxareas );
}
...
{
	return 0;//syscall( BOTLIB_AAS_AVOIDDANGERAREA, srcpos, srcarea, dangerpos, dangerarea, PASSFLOAT( range ), travelflags );
}
...
{
	return 0;//syscall( BOTLIB_AAS_RETREAT, dangerSpots, dangerSpotCount, srcpos, srcarea, dangerpos, dangerarea, PASSFLOAT( range ), PASSFLOAT( dangerRange ), travelflags );
}
...
{
	return 0;//syscall( BOTLIB_AI_LOAD_CHARACTER, charfile, skill );
}
...
{
	return 0;//syscall( BOTLIB_AI_CHARACTERISTIC_INTEGER, character, index );
}
...
{
	return 0;//syscall( BOTLIB_AI_CHARACTERISTIC_BINTEGER, character, index, min, max );
}
...
{
	return 0;//syscall( BOTLIB_AI_ALLOC_CHAT_STATE );
}
...
{
	return 0;//syscall( BOTLIB_AI_NEXT_CONSOLE_MESSAGE, chatstate, cm );
}
...
{
	return 0;//syscall( BOTLIB_AI_NUM_CONSOLE_MESSAGE, chatstate );
}
...
{
	return 0;//syscall( BOTLIB_AI_NUM_INITIAL_CHATS, chatstate, type );
}
...
{
	return 0;//syscall( BOTLIB_AI_REPLY_CHAT, chatstate, message, mcontext, vcontext, var0, var1, var2, var3, var4, var5, var6, var7 );
}
...
{
	return 0;//syscall( BOTLIB_AI_CHAT_LENGTH, chatstate );
}
...
{
	return 0;//syscall( BOTLIB_AI_STRING_CONTAINS, str1, str2, casesensitive );
}
...
{
	return 0;//syscall( BOTLIB_AI_FIND_MATCH, str, match, context );
}
...
{
	return 0;//syscall( BOTLIB_AI_LOAD_CHAT_FILE, chatstate, chatfile, chatname );
}
...
{
	return 0;//syscall( BOTLIB_AI_GET_TOP_GOAL, goalstate, goal );
}
...
{
	return 0;//syscall( BOTLIB_AI_GET_SECOND_GOAL, goalstate, goal );
}
...
{
	return 0;//syscall( BOTLIB_AI_CHOOSE_LTG_ITEM, goalstate, origin, inventory, travelflags );
}
...
{
	return 0;//syscall( BOTLIB_AI_CHOOSE_NBG_ITEM, goalstate, origin, inventory, travelflags, ltg, PASSFLOAT( maxtime ) );
}
...
{
	return 0;//syscall( BOTLIB_AI_TOUCHING_GOAL, origin, goal );
}
...
{
	return 0;//syscall( BOTLIB_AI_ITEM_GOAL_IN_VIS_BUT_NOT_VISIBLE, viewer, eye, viewangles, goal );
}
...
{
	return 0;//syscall( BOTLIB_AI_GET_LEVEL_ITEM_GOAL, index, classname, goal );
}
...
{
	return 0;//syscall( BOTLIB_AI_GET_NEXT_CAMP_SPOT_GOAL, num, goal );
}
...
{
	return 0;//syscall( BOTLIB_AI_GET_MAP_LOCATION_GOAL, name, goal );
}
...
{
	return 0;//syscall( BOTLIB_AI_LOAD_ITEM_WEIGHTS, goalstate, filename );
}
...
{
	return 0;//syscall( BOTLIB_AI_ALLOC_GOAL_STATE, state );
}
...
{
	return 0;//syscall( BOTLIB_AI_MOVE_IN_DIRECTION, movestate, dir, PASSFLOAT( speed ), type );
}
...
{
	return 0;//syscall( BOTLIB_AI_REACHABILITY_AREA, origin, testground );
}
...
{
	return 0;//syscall( BOTLIB_AI_MOVEMENT_VIEW_TARGET, movestate, goal, travelflags, PASSFLOAT( lookahead ), target );
}
...
{
	return 0;//syscall( BOTLIB_AI_PREDICT_VISIBLE_POSITION, origin, areanum, goal, travelflags, target );
}
...
{
	return 0;//syscall( BOTLIB_AI_ALLOC_MOVE_STATE );
}
...
{
	return 0;//syscall( BOTLIB_AI_CHOOSE_BEST_FIGHT_WEAPON, weaponstate, inventory );
}
...
{
	return 0;//syscall( BOTLIB_AI_LOAD_WEAPON_WEIGHTS, weaponstate, filename );
}
...
{
	return 0;//syscall( BOTLIB_AI_ALLOC_WEAPON_STATE );
}
...
{
	return 0;//syscall( BOTLIB_AI_GENETIC_PARENTS_AND_CHILD_SELECTION, numranks, ranks, parent1, parent2, child );
}
