...
equ trap_openURL                          -360
equ trap_GetHunkData                      -361
equ trap_QuoteString                      -362
equ trap_R_RegisterAnimation              -363
equ trap_R_BuildSkeleton                  -364
equ trap_R_BlendSkeleton                  -365
equ trap_R_BoneIndex                      -366
equ trap_R_AnimNumFrames                  -367
equ trap_R_AnimFrameRate                  -368
equ trap_Gettext                          -369
equ trap_R_Glyph                          -370
equ trap_R_GlyphChar                      -371
equ trap_R_UnregisterFont                 -372
equ trap_Pgettext                         -373
