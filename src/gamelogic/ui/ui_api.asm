...
equ trap_openURL                          -362
equ trap_GetHunkData                      -363
equ trap_QuoteString                      -364
equ trap_R_RegisterAnimation              -365
equ trap_R_BuildSkeleton                  -366
equ trap_R_BlendSkeleton                  -367
equ trap_R_BoneIndex                      -368
equ trap_R_AnimNumFrames                  -369
equ trap_R_AnimFrameRate                  -370
equ trap_Gettext                          -371
equ trap_R_Glyph                          -372
equ trap_R_GlyphChar                      -373
equ trap_R_UnregisterFont                 -374
