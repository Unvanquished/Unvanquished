...
class IgnitableComponent: public IgnitableComponentBase {
	...
	public:
		 ...
		 * @param freeOnExtinguish An initialization parameter.
		 ...
		 */
		IgnitableComponent(Entity& entity, bool freeOnExtinguish, ThinkingComponent& r_ThinkingComponent);
		...
		/**
		 * @brief Handle the Frame message.
		 * @param timeDelta
		 * @note This method is an interface for autogenerated code, do not modify its signature.
		 */
		void HandleFrame(int timeDelta);
