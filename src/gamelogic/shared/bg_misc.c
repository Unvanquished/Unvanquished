...
static const beaconData_t bg_beaconsData[ ] =
{
	...
	{ BCT_BASE,          "base",          BCF_BASE | BCF_PER_TEAM },
	{ BCT_BASE_ENEMY,    "base-enemy",    BCF_BASE | BCF_PER_TEAM },
	{ BCT_OUTPOST,       "outpost",       BCF_BASE },
	{ BCT_OUTPOST_ENEMY, "outpost-enemy", BCF_BASE },
	{ BCT_ATTACK,        "attack",        0 },
	{ BCT_DEFEND,        "defend",        0 },
