...
elseif (LINUX)
    set(BREAKPAD_LIST
        ${LIB_DIR}/breakpad/client/linux/crash_generation/crash_generation_client.cc
        ${LIB_DIR}/breakpad/client/linux/crash_generation/crash_generation_server.cc
        ${LIB_DIR}/breakpad/client/linux/dump_writer_common/thread_info.cc
        ${LIB_DIR}/breakpad/client/linux/dump_writer_common/ucontext_reader.cc
        ${LIB_DIR}/breakpad/client/linux/handler/exception_handler.cc
        ${LIB_DIR}/breakpad/client/linux/handler/minidump_descriptor.cc
        ${LIB_DIR}/breakpad/client/linux/log/log.cc
        ${LIB_DIR}/breakpad/client/linux/microdump_writer/microdump_writer.cc
        ${LIB_DIR}/breakpad/client/linux/minidump_writer/linux_dumper.cc
        ${LIB_DIR}/breakpad/client/linux/minidump_writer/linux_ptrace_dumper.cc
        ${LIB_DIR}/breakpad/client/linux/minidump_writer/minidump_writer.cc
        ${LIB_DIR}/breakpad/client/minidump_file_writer.cc
        ${LIB_DIR}/breakpad/common/convert_UTF.c
        ${LIB_DIR}/breakpad/common/md5.cc
        ${LIB_DIR}/breakpad/common/string_conversion.cc
        ${LIB_DIR}/breakpad/common/linux/elfutils.cc
        ${LIB_DIR}/breakpad/common/linux/file_id.cc
        ${LIB_DIR}/breakpad/common/linux/guid_creator.cc
        ${LIB_DIR}/breakpad/common/linux/linux_libc_support.cc
        ${LIB_DIR}/breakpad/common/linux/memory_mapped_file.cc
        ${LIB_DIR}/breakpad/common/linux/safe_readlink.cc
    )
endif()
