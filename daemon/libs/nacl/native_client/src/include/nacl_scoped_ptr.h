...
#ifndef NATIVE_CLIENT_SRC_INCLUDE_NACL_SCOPED_PTR_H_
#define NATIVE_CLIENT_SRC_INCLUDE_NACL_SCOPED_PTR_H_
...
#endif  // NATIVE_CLIENT_SRC_INCLUDE_NACL_SCOPED_PTR_H_
