...
set( FREETYPE_INCLUDE_DIRS ${LIB_DIR}/freetype/include/freetype2 CACHE STRING "Freetupe include directory" FORCE )
...
set( VORBIS_LIBRARY optimized ${LIB_DIR}/libvorbis/libs/Win32/Release/libvorbis.lib optimized ${LIB_DIR}/libvorbis/libs/Win32/Release/libvorbisfile.lib
  debug ${LIB_DIR}/libvorbis/libs/Win32/Debug/libvorbis.lib debug ${LIB_DIR}/libvorbis/libs/Win32/Release/libvorbisfile.lib CACHE STRING "Vorbis library" FORCE )
set( OGG_INCLUDE_DIRS ${LIB_DIR}/libogg/include CACHE STRING "Ogg include directory" FORCE )
set( OGG_LIBRARIES optimized ${LIB_DIR}/libogg/libs/win32/release/libogg.lib debug ${LIB_DIR}/libogg/libs/win32/debug/libogg.lib CACHE STRING "Ogg library" FORCE )
set( THEORA_INCLUDE_DIRS ${LIB_DIR}/libtheora/include CACHE STRING "Theora include directory" FORCE )
set( THEORA_LIBRARIES optimized ${LIB_DIR}/libtheora/libs/win32/release/libtheora.lib debug ${LIB_DIR}/libtheora/libs/win32/debug/libtheora.lib CACHE STRING "Theora library" FORCE )
